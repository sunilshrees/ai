...
const Child = (props: any) => {
  ...
  return (
    <div className="w-full pr-[20px] text-black">
      ...
      <div className="w-full mb-[30px] flex flex-col gap-y-[10px]">
        ...
        <div className="flex flex-col gap-y-[10px]">
          ...
          <input
            {...register('position')}
            type="text"
            placeholder="Chief Operation Officer"
            className="ring-0 outline-none border border-[#D1D1D1] p-[10px] rounded-[10px] bg-[#FFFFFF80]"
          />
        </div>
      ...
      <div className="w-full flex justify-end items-center gap-[15px] text-[16px] text-white font-medium pb-[1.25rem]">
        <button
