...
const Child = (props: any) => {
  ...
  const coverPic = watch('attached_files')
  ...
  return (
    <div className="w-full pr-[20px] text-black">
      ...
      <div className="w-full mb-[30px] flex flex-col gap-y-[10px]">
        ...
        <div className="flex flex-col gap-y-[10px]">
          <label htmlFor="links" className="text-[12px] md:text-[14px]">
            Link
          </label>
          <input
            {...register('links')}
          ...
          <div className="w-full mb-[30px] flex flex-col gap-y-[10px]">
            <div className="flex flex-col gap-y-[10px]">
                  ...
                  {coverPic && (
                    <div className="absolute w-full !z-30">
                      <div className="flex flex-col justify-center items-center relative overflow-hidden ">
                        <i className="bx bxs-file-pdf text-[80px]"></i>
                        {isFileList(coverPic) ? (
                          <div className="text-primary  text-[16px] p-2">
                            {coverPic?.[0]?.name}
                          </div>
                        ) : (
                          <div className="text-primary  text-[16px] p-2">
              ...
              {errors?.attached_files && (
                <div className="text-red-500 text-[0.75rem]">
                  {errors?.attached_files?.message?.toString()}
                </div>
              )}
            </div>
          </div>
