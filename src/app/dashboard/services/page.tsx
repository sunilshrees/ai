...
import CreateComponent from '@/container/services/company-service/CreateComponent'
import EditComponent from '@/container/services/company-service/EditComponent'
...
const Page = () => {
  ...
  const getProductList = async () => {
    ...
    try {
      const response = await apiHandler.get(`${API_URLS.GET_SERVICE_API}`)
