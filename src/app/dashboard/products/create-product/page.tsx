...
import CreateComponent from '@/container/products/create-product/CreateComponent'
import EditComponent from '@/container/products/create-product/EditComponent'
...
const Page = () => {
  ...
  const getProductList = async () => {
    ...
    try {
      const response = await apiHandler.get(`${API_URLS.GET_PRODUCT_API}`)
